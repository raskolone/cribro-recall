              ...
              <Card className="p-6 border border-white/5 shadow-xl bg-base-200/40 backdrop-blur-xl relative overflow-hidden">
                ...
                <div className="mb-8">
                  ...
                  <div className="flex bg-base-300/50 p-1.5 rounded-xl">
                    <button
                      onClick={() => setTranslationInputMode('typing')}
                    ...
                    <button
                      onClick={() => setTranslationInputMode('puzzle')}
                      className={`flex-1 py-3 px-4 rounded-lg text-sm font-bold transition-all duration-300 flex items-center justify-center gap-2 ${
                        translationInputMode === 'puzzle' 
                          ? 'bg-white text-black shadow-md' 
                          : 'text-content-muted hover:text-white'
                      }`}
                    >
                ...
                {practiceMode === 'time' && (
                  <div className="text-center p-6 bg-primary/5 rounded-xl border border-primary/20 mb-6">
                    ...
                    <p className="text-content-muted text-sm">
                      {language === 'pl' 
                        ? 'Masz 2 minuty na przetłumaczenie jak największej liczby zdań. Powodzenia!' 
                        : 'You have 2 minutes to translate as many sentences as possible. Good luck!'}
                    </p>
                  </div>
                )}
              </Card>
...
print("Updated setup UI successfully!")
