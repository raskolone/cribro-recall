...
const oldStart = `                      <div className="space-y-2.5">
                        {/* Opcja 1: Lekcje */}
...
const newStart = `                      <div className="space-y-4">
...
const oldLabel = `                            <div className="flex items-center gap-3">
...
const newLabel = `                            <div className="flex items-center gap-4">
...
console.log("Patched Generator Start");
