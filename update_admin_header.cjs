...
const newHeader = `{/* Top Header */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pt-1 sm:pt-0 pl-8 sm:pl-0">
        <div>
...
if (code.includes(oldHeader)) {
  ...
  console.log('Header updated successfully in AdminPanel.tsx');
} else {
  console.log('Header old match failed in AdminPanel.tsx');
}
