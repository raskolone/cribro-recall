...
// remove bad buttons
const badButtonsRegex = /<div className="flex gap-3 mb-4">[\s\S]*?<\/div>\n\s*<textarea\n\s*value=\{profileForm.description\}/;
code = code.replace(badButtonsRegex, '<textarea\n                  value={profileForm.description}');

// add buttons to correct place
const buttonsHtml = `
...
code = code.replace(/<textarea\n\s*value=\{rawMeetingNotes\}/, buttonsHtml + '              value={rawMeetingNotes}');
