...
const translations = {
  en: {
    ...
    'hero.subtitle': 'Maciej Wyrozumski',
    'hero.title': 'VocabBoost AI',
    'hero.start': 'Start Learning Now',
    'about.title': 'About App',
    'about.word1': 'Generator.',
    'about.word2': 'Coach.',
    'about.word3': 'Assistant.',
    'about.desc': 'VocabBoost AI is a modern tool for learning foreign languages. It uses artificial intelligence to generate vocabulary tailored to your level, offers interactive exercises, and a spaced repetition system.',
  ...
  pl: {
    ...
    'about.desc': 'VocabBoost AI to nowoczesne narzędzie do nauki języków obcych. Wykorzystuje sztuczną inteligencję do generowania słownictwa dopasowanego do Twojego poziomu, oferuje interaktywne ćwiczenia i system powtórek.',
