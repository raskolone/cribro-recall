      ...
      return (
        <div className="min-h-screen flex items-center justify-center bg-[#0a0e1a] text-white p-4">
          <div className="bg-red-500/10 border border-red-500 p-8 rounded-2xl max-w-lg w-full text-center">
            <h1 className="text-2xl font-bold mb-4">{i18n.t("Wystąpił błąd aplikacji")}</h1>
            <p className="mb-6 opacity-80">
              
                                    {i18n.t("Coś poszło nie tak i aplikacja nie mogła zostać poprawnie wyświetlona.               Spróbuj się wylogować i zalogować ponownie.")}
                                  </p>
