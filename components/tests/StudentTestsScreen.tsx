  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-3xl font-bold">Twoje Testy</h1>
      </div>
        ...
        <div className="space-y-4">
            ...
            <Card key={test.id} className="p-6 flex flex-col md:flex-row items-center justify-between gap-4">
              <div>
                ...
                <div className="flex gap-4 mt-3 text-xs font-mono">
                  <span className="text-orange-300">Do: {test.dueDate}</span>
                  <span className="text-blue-300">Pytań: {test.questions.length}</span>
                </div>
              </div>
          ...
          {tests.length === 0 && (
            <div className="text-center py-12 text-content-muted">
              Nie masz aktualnie żadnych przypisanych testów.
            </div>
          )}
        </div>
      )}
