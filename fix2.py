                ...
                {q.type === 'writing' && (
                  <div>
                    ...
                    <textarea
                      ...
                      onCut={(e) => e.preventDefault()}
                      placeholder="Zacznij pisać tutaj..."
                      className="w-full bg-base-100 border border-white/10 rounded-xl p-4 text-lg outline-none focus:border-primary/50 focus:ring-1 focus:ring-primary/50 transition-all min-h-[200px] resize-y"
                    />
                  </div>
                )}
              </div>
